...
export default class Board extends React.Component {
  constructor(props) {
    ...
    this.componentDidMount = () => {
      ...
      function drag(el, target, sibling) {
        let newContainerTitle = target.previousElementSibling.textContent;
        if (newContainerTitle === "In Progress") {
          el.className = "Card Card-blue";
        } else if (newContainerTitle === "Backlog") {
